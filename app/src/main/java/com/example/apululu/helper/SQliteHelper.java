...
public class SQliteHelper extends SQLiteOpenHelper {
    ...
    private static final String PROFILES_TABLE_CREATE = "CREATE TABLE profiles(_id INTEGER PRIMARY KEY AUTOINCREMENT, userId NUMERIC, firtsName TEXT, lastName TEXT, age NUMERIC, city TEXT, sex TEXT, work TEXT, study TEXT, other TEXT)";
